...
async function geocodeAddress(query) {
  ...
  const url = `https://nominatim.openstreetmap.org/search?format=jsonv2&limit=5&addressdetails=1&countrycodes=br&viewbox=${encodeURIComponent(viewbox)}&bounded=1&q=${encodeURIComponent(expanded)}`;
